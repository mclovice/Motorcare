...
public class Recycler_Spare_Retrieve_CarOwner extends AppCompatActivity {
    private ArrayList<Spare_Retrieve_getters> mData;
    private ArrayList<String> mDataId;
    private SpareFullAdapter mAdapter;
    ...
    public Recycler_Spare_Retrieve_CarOwner() {
    }
    ...
    private ChildEventListener childEventListener = new ChildEventListener() {
        ...
        public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
            mData.add(dataSnapshot.getValue(Spare_Retrieve_getters.class));
        ...
        public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
            ...
            mData.set(mechanic, dataSnapshot.getValue(Spare_Retrieve_getters.class));
            mAdapter.notifyDataSetChanged();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler__spare__retrieve__car_owner);
        ...
        mReference = FirebaseDatabase.getInstance().getReference("SpareParts");
        ...
        RecyclerView recyclerView = findViewById(R.id.spare_retrieve_recyclerView);
        ...
        View emptyView = findViewById(R.id.empty_view_spare_retrieve);
        mAdapter = new SpareFullAdapter(this, mData, mDataId, emptyView, new SpareFullAdapter.ClickHandler(){
            ...
            public void onItemClick(int position) {
                ...
                Toast.makeText(Recycler_Spare_Retrieve_CarOwner.this, pet, Toast.LENGTH_SHORT).show();
            }
