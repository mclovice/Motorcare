...
public class Recycler_Emergency_retrieve_Mech extends AppCompatActivity {
    private ArrayList<Emerge_Retrieve_getters> mData;
    private ArrayList<String> mDataId;
    private EmergencyAdapterFull mAdapter;
    ...
    public Recycler_Emergency_retrieve_Mech() {
    }
    ...
    private ChildEventListener childEventListener = new ChildEventListener() {
        ...
        public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
            mData.add(dataSnapshot.getValue(Emerge_Retrieve_getters.class));
        ...
        public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
            ...
            mData.set(mechanic, dataSnapshot.getValue(Emerge_Retrieve_getters.class));
            mAdapter.notifyDataSetChanged();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler__emergency_retrieve__mech);
        ...
        mReference = FirebaseDatabase.getInstance().getReference("Emergencies");
        ...
        RecyclerView recyclerView = findViewById(R.id.emergency_retrieve_recyclerView);
        ...
        View emptyView = findViewById(R.id.empty_view_emergency_retrieve);
        mAdapter = new EmergencyAdapterFull(this, mData, mDataId, emptyView, new EmergencyAdapterFull.ClickHandler(){
            ...
            public void onItemClick(int position) {
                ...
                Toast.makeText(Recycler_Emergency_retrieve_Mech.this, pet, Toast.LENGTH_SHORT).show();
            }
